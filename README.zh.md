...
| 组件 | 定位 | 仓库 |
|------|------|------|
| **ColdCEAL** | 演绎对齐中间层（对话合规） | [cold-os/cold-ceal](https://github.com/cold-os/cold-ceal) |
| **ColdCAGE** | 安全隔离框架（行动隔离） | [cold-os/cold-cage](https://github.com/cold-os/cold-cage) |
| **ColdMirror** | 轻量级安全智能体框架（应用模板） | [cold-os/cold-mirror](https://github.com/cold-os/cold-mirror) |
